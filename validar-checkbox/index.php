...
<title>Comprobar valor del checkbox con PHP</title>
<meta name="description" content="Comprobar valor del checkbox con PHP..."/>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
        <div class="navbar-nav">
            ...
            <a class="nav-item nav-link" href="#">Descargar</a>
...
<div class="container">
    ...
    <div class="row">
        <div id="content" class="col-lg-12">
            ...
            ?>
            <form action="../habeas.php" method="post">
    ...
    <div class="footer-content row">
        <div class="col-lg-12">
            <div class="pull-right">
                <a href="https://www.jose-aguilar.com/blog/accordeon-con-jquery/" class="btn btn-secondary">
                    <i class="fa fa-reply"></i> volver al tutorial
                </a>
                <a href="https://www.jose-aguilar.com/scripts/jquery/accordeon-me/accordeon-me.zip" class="btn btn-primary">
